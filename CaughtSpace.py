...
description='CaughtSpace Provides High Quality Images from NASA APOD [ June 1995 Onwards ]')
...
┃┃┃┃┃┃┃┃┃┃┃┃━━┛┃┃┃┃┃┃┃┃┃┃┃┃┃┛┃┃┃┃┃┃┃┃┃┃┃┃┃┃┃┃┃┃━━┛┃┃┃┃┃┃┃┃┃┃┃┃┃┃┃┃┃┃┃┃┃┃┃┃┃┃
	print (G + banner + W + '\n')
	print (G + '[>]' + C + ' Created By : ' + W + 'anirudddh')
	print (G + '[>]' + C + ' Version    : ' + W + version + '\n')

def updater():
	print (G + '[+]' + C + ' Checking For Updates...' + W, end='')
	update = requests.get('https://raw.githubusercontent.com/anirudddh/CaughtSpace/master/version.txt', timeout = 5)
...
def master(i):
	...
	for t in threads:
		t.join()
	img()
	print (G + '[+]' + C + ' CaughtSpace is Ready...Reload Page...' + W)
...
def img():
	global url, arr
	with open ('website/js/CaughtSpace.js', 'w') as imgfile:
